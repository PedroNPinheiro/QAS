        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          {!isNew && !editing && user?.role === 'admin' && (
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-red-200 bg-surface px-3 py-2 text-sm font-medium text-red-600 transition-colors hover:bg-red-50 dark:border-red-400/30 dark:text-red-400 dark:hover:bg-red-400/10"
            >
